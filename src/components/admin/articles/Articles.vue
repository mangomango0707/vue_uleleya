        ...
        <el-dialog title="修改文章" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
            ...
            <el-form ref="editFormRef" :model="editForm" :rules="editFormRules" label-width="80px">
              ...
              <el-form-item label="封面">
                  <el-upload action="http://127.0.0.1:8082/admin/editArticle" :http-request="editArticle" ref="upload" multiple :auto-upload="false">
              ...
              <el-form-item label="类型">
                  <el-select v-model="editForm.type" clearable placeholder="请选择文章类型">
              ...
              <el-form-item label="标签">
                  <el-select v-model="editForm.tag" clearable placeholder="请选择文章标签">
